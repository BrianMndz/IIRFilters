...
namespace wpdsp {
    ...
    double Biquad::processAudioSample(double sample) {
        ...
        if (m_biquadAlgorithm == BiquadAlgorithm::kDirect) {
        ...
        if (m_biquadAlgorithm == BiquadAlgorithm::kTransposeDirect) {
        ...
        if (m_biquadAlgorithm == BiquadAlgorithm::kTransposeCanonical) {
